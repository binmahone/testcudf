 ...
 * Shows detailed timing for each iteration including warmup
 */
...
/**
 * Perform cast(coalesce(x, 0) as double)
 */
...
int main() {
    ...
    std::cout << "========================================" << std::endl;
    std::cout << "Cast(Coalesce) Strategy Comparison" << std::endl;
    std::cout << "  Workload: cast(coalesce(x, 0) as double)" << std::endl;
    ...
    std::cout << "  RMM Pool: 2GB" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "========================================" << std::endl;
    std::cout << "Strategy 1: Individual cast(coalesce) (200 ops)" 
              << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << std::endl;
    ...
    for (size_t i = 0; i < NUM_WARMUP; ++i) {
        ...
        for (size_t col = 0; col < NUM_COLUMNS; ++col) {
            auto temp = coalesce_and_cast_column(input_columns[col]->view());
        }
        cudaDeviceSynchronize();
    ...
    std::cout << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << "Strategy 2: Concat->Cast(Coalesce)->Split(view)" 
              << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Strategy 1 (Individual cast(coalesce)):" << std::endl;
