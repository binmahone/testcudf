...
/**
 * Test mutex optimization on ORIGINAL workloads with ARENA memory resource
 */
...
int main() {
    ...
    std::cout << "=== ARENA Memory Resource Test ===" << std::endl;
    std::cout << "Memory: Arena (10GB pre-allocated)" << std::endl;
    ...
    std::cout << "========================================" << std::endl;
    std::cout << "Summary - ARENA Memory Resource" << std::endl;
    std::cout << "========================================" << std::endl;
