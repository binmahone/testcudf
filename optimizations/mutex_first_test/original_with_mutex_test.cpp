...
/**
 * Test mutex optimization on ORIGINAL (unoptimized) workloads
 * This tests: original workload + concurrent vs mutex submission
 */
...
// Workload 1 - ORIGINAL (3 kernels: is_valid, copy_if_else, cast)
...
int main() {
    ...
    std::cout << "=== Mutex Test on ORIGINAL (Unoptimized) Workloads ===" 
              << std::endl;
    ...
    // Test Workload 1 (Original: 3 kernels)
    ...
    // Test Workload 2 (Original: 5+ kernels)
    ...
    std::cout << "Testing mutex optimization on ORIGINAL workloads:" 
              << std::endl;
    std::cout << "  - W1: 3 kernels per item (is_valid, copy_if_else, cast)" 
              << std::endl;
    std::cout << "  - W2: 5+ kernels per item (more complex pipeline)" 
              << std::endl;
    std::cout << std::endl;
    std::cout << "Mutex provides speedup by avoiding kernel submission" 
              << std::endl;
    std::cout << "contention, even without kernel count optimization." 
              << std::endl;
