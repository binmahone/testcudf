...
/**
 * MUTEX mode only - for nsys profiling with ASYNC memory resource
 */
...
int main() {
    ...
    std::cout << "=== MUTEX Mode with ASYNC Memory (for nsys) ===" 
              << std::endl;
    ...
    std::cout << "Running Workload 1 (MUTEX) - 3 runs..." << std::endl;
    ...
    std::cout << std::endl << "MUTEX mode completed." << std::endl;
